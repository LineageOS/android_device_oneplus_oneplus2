...
Return<void> TouchscreenGesture::getSupportedGestures(getSupportedGestures_cb _hidl_cb) {
    ...
    gestures.push_back(Gesture{0, "up arrow", 251});
    gestures.push_back(Gesture{0, "right arrow", 252});
    gestures.push_back(Gesture{0, "left arrow", 253});
    gestures.push_back(Gesture{0, "letter o", 254});
    gestures.push_back(Gesture{0, "two finger down swipe", 255});
    gestures.push_back(Gesture{0, "one finger right swipe", 256});
    gestures.push_back(Gesture{0, "one finger left swipe", 257});
    gestures.push_back(Gesture{0, "one finger down swipe", 258});
    gestures.push_back(Gesture{0, "one finger up swipe", 259});

 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.0-service.oneplus2"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.0-service.oneplus2"
